...
//        System.out.println("dto5 = " + dto5);
    ...
    //    연습
//    name(텍스트), birth_date(날짜), score(소수점 2자리까지), born_at(날짜시간) table13 만들기
//    html * 1
//    request handler method * 2 (get, post)
    @Data
    static class Dto7 {
        private String name; // VARCHAR
        private LocalDate birth_date; // DATE
        private Double score; // DEC
        private LocalDateTime born_at; // DATETIME
    }
    ...
    public String process7(Dto7 dto7) throws Exception {
        ...
        statement.setDate(2, Date.valueOf(dto7.getBirth_date()));
        statement.setDouble(3, dto7.getScore());
        statement.setTimestamp(4, Timestamp.valueOf(dto7.getBorn_at()));
