...
import com.example.spring.dto.MyBean071;
...
public class Controller07 {
    ...
    public String sub2(Model model){
        ...
        model.addAttribute("myList", List.of(
                new MyBean071("lee", "01-01", 5000),
                new MyBean071("kim", "02-02", 4000),
                new MyBean071("son", "03-03", 6000),
                new MyBean071("park", "04-04", 3000),
                new MyBean071("choi", "05-05", 7000)));
